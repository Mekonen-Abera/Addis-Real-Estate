...
export default function CreateListing() {
    ...
    return (
        <main className='p-4 max-w-5xl mx-auto'>
            <h1 className='text-4xl font-semibold text-center my-8'>Create a Listing</h1>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    {formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
                        <div key={url} className='flex justify-between p-4 border items-center'>
                            <img src={url} alt='listing' className='w-30 h-30 object-contain rounded-lg' />
                            <button
                                type='button'
                                onClick={() => handleRemoveImage(index)}
                                className='p-4 text-red-800 rounded-lg uppercase hover:opacity-95'
                            >
                                Delete
                            </button>
                        </div>
                    ...
                    <button
                        ...
                        className='p-4 bg-slate-800 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'
                    >
